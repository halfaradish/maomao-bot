...
class Config(BaseModel):
    ...
    post_groups: str = "post_groups"
    receive_groups: str = "receive_groups"
    ...
    HELP_MSG: str = (
        ...
        "\"/搬史 addpost *group_id\" - 添加可以发送bs命令的群组\n"
        "\"/搬史 addreceive *group_id\" - 添加可以接收转发的群组\n"
        "\"/搬史 rmpost *group_id\" - 移除可以发送bs命令的群组\n"
        "\"/搬史 rmreceive *group_id\" - 移除可以接收转发的群组\n"
